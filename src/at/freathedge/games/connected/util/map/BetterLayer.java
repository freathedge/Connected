...
public class BetterLayer {
    ...
    public BetterLayer(BetterTiledMap map, Element element) throws SlickException {
        this.map = map;
                ...
                for(int y = 0; y < this.height; ++y) {
                    for(int x = 0; x < this.width; ++x) {
                        ...
                        if (tileId == 0) {
                            ...
                            BetterTileSet set = map.findTileSet(tileId);
                            if (set != null) {
    ...
    public void setTileID(int x, int y, int tile) {
        if (tile == 0) {
            ...
            BetterTileSet set = this.map.findTileSet(tile);
            this.data[x][y][0] = set.index;
